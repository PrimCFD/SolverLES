 ...
 *
 * @details
 * Shared libraries register factories under string keys using the exported
 * function ``physics_register_v1``. The application resolves keys from its
 * configuration (e.g., YAML) and constructs the selected components.
 *
 * @rst
 * .. code-block:: cpp
 *

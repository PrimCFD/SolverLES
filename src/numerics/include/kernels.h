...
extern "C"
{
    ...
    void divergence(const double* u, const double* v, const double* w, int nxu_tot, int nyu_tot,
                    ...
                    double dy, double dz, double* div);
    ...
    void correct_velocity_const_rho(double* u, double* v, double* w, const double* dpx_u,
                                    ...
                                    int nyu_tot, int nzu_tot, int nxv_tot, int nyv_tot, int nzv_tot,
                                    int nxw_tot, int nyw_tot, int nzw_tot, int nxc_tot, int nyc_tot,
                                    int nzc_tot, int ng, double rho, double dt);
    ...
    void diffuse_fe(const double* u, int nxu_tot, int nyu_tot, int nzu_tot, const double* v,
                    int nxv_tot, int nyv_tot, int nzv_tot, const double* w, int nxw_tot,
                    int nyw_tot, int nzw_tot, const double* nu_eff, int nxc_tot, int nyc_tot,
                    int nzc_tot, int ng, double dx, double dy, double dz, double dt, double* uo,
                    double* vo, double* wo);
    ...
    void diffuse_be_jacobi_sweep(const double* u_rhs, const double* v_rhs, const double* w_rhs,
                                 ...
                                 int nzv_tot, int nxw_tot, int nyw_tot, int nzw_tot, int ng,
                                 double dx, double dy, double dz, double dt, double* u_next,
                                 double* v_next, double* w_next);
    ...
    void diffuse_be_rbgs_color(double* u, double* v, double* w, const double* u_rhs,
                               ...
                               double dt, int color /* 0=red, 1=black */);
    ...
    void diffuse_be_residual(const double* u_rhs, const double* v_rhs, const double* w_rhs,
                             ...
                             double dy, double dz, double dt, double* res2, double* rhs2);
    ...
    void advect_kk3(const double* u, int nxu_tot, int nyu_tot, int nzu_tot, const double* v,
                    int nxv_tot, int nyv_tot, int nzv_tot, const double* w, int nxw_tot,
                    int nyw_tot, int nzw_tot, int ng, double dx, double dy, double dz, double* Nu,
                    double* Nv, double* Nw);

...
set(_petsc_install "${_DEPS_BASE}/petsc-install" CACHE PATH "")

# Upstream tarball (unchanged)
set(_petsc_url "https://gitlab.com/petsc/petsc/-/archive/v3.20.0/petsc-v3.20.0.tar.gz")
...
# BLAS/LAPACK: prefer built OpenBLAS (module) unless USE_SYSTEM_BLAS is set by the root
set(_petsc_deps)
...
if(NOT _blas_libloc)
  # BLAS::BLAS/LAPACK::LAPACK are INTERFACE; try common locations from CMAKE_PREFIX_PATH
  # (best-effort; usually OpenBLAS::openblas gives us the path)
  set(_blas_libloc "")
endif()
...
ExternalProject_Add(petsc
  ...
  DEPENDS           ${_petsc_deps}
  BUILD_BYPRODUCTS  "${_petsc_install}/lib/libpetsc${CMAKE_SHARED_LIBRARY_SUFFIX}"
)

# Expose for find_package(PETSc CONFIG) if a config is generated
set(PETSC_DIR "${_petsc_install}" CACHE PATH "" FORCE)

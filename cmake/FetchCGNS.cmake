...
set_target_properties(CGNS::cgns PROPERTIES
  IMPORTED_LOCATION             "${_cgns_lib}"
  INTERFACE_INCLUDE_DIRECTORIES "${_cgns_install}/include"
)
add_dependencies(CGNS::cgns cgns_ep)

# Help find_package(CGNS CONFIG) downstream if desired
set(CGNS_DIR "${_cgns_install}/lib/cmake/CGNS" CACHE PATH "" FORCE)

...
# FETCHCONTENT_BASE_DIR if provided by the toolchain/driver script.
...
# Compose URL args for FetchContent/ExternalProject If an extern/<name>-*.tgz
# exists, use it (with URL_HASH); else use fallback URL. fu_url_args(<name>
# <fallback_url> <out_args_var>)
function(fu_url_args name default_url out_args)
  fu_find_extern_archive("${name}" _local _hash)
  if(_local)
    if(_hash)
      set(${out_args}
          "URL;${_local};URL_HASH;SHA256=${_hash}"
          PARENT_SCOPE)
    else()
      set(${out_args}
          "URL;${_local}"
